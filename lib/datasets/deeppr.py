...
class deeppr(imdb):
    ...
    def _get_default_path(self):
        """
        Return the default path where DeepPR is expected to be installed.
        """
        return os.path.join(cfg.DATA_DIR, 'DeepPR')
    ...
    def gt_roidb(self):
        ...
        gt_roidb = [self._load_deeppr_annotation(index)
    ...
    def _load_deeppr_annotation(self, index):
        """
        Load image and bounding boxes info from txt files of DeepPR.
        """
